...
@section('main_content_admin_part')
    ...
    <h5 class="text-gray-800 text-xl font-bold mt-3">Modification de l'activité</h5>
    ...
    <form method="POST" action="{{ route('activites.update', $activite) }}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
          ...
          <input type="text" value="{{ $activite->nom_activite }}" name="nom_activite" placeholder="Saisissez le nom de l'activité"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>
