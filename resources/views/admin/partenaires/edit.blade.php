...
@section('main_content_admin_part')
    ...
    <h5 class="text-gray-800 text-xl font-bold mt-3">Modification du Partenaire</h5>
    ...
    <form method="POST" action="{{ route('partenaires.update', $partenaire) }}" enctype="multipart/form-data">
        ...
        <div class="mb-6">
          ...
          <input type="text" name="name" value="{{ $partenaire->name }}" placeholder="Saisissez le nom du partenaire"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
        </div>
            ...
            <div class="w-full">
                <div class="mx-3">
                    <div class="single_form mt-8">
                        <textarea name="commentaires" value ="{{ $partenaire->commentaires }}" id="message" placeholder="Message" rows="5" class="w-full rounded-md py-4 px-6 border border-solid border-body-color resize-none"></textarea>
                    </div> <!-- single form -->
                </div>
            </div>
          </div>
