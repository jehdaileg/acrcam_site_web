...
@section('main_content_admin_part')
    ...
    <h5 class="text-gray-800 text-xl font-bold">Types des Projets</h5>
    ...
    <div class="mt-7 mb-5">
        <a href="{{ route('typeprojets.create') }}" class="px-4 py-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-8 sm:w-auto  py-4.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Ajouter un type de Projet</a>
 ...
 <table class="shadow-lg bg-white border-collapse absolute">
    ...
    <tbody>
        ...
        <tr>
            <td class="border px-5 py-2">{{ $type_projet->nameTypeProjet }}</td>
