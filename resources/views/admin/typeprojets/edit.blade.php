...
@section('main_content_admin_part')
    ...
    <form method="POST" action="{{ route('typeprojets.update', $type_projet->id) }}">
        @csrf
        ...
        <div class="mb-6">
          ...
          <input type="text" value="{{ $type_projet->nameTypeProjet }}">
          <input type="text" name="nameTypeProjet" placeholder="Saisissez le type de projet"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"  value="{{ $type_projet->nameTypeProjet }}" >
        </div>
