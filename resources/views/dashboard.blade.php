      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
          ...
          <h1 class="hidden md:block font-bold text-sm md:text-xl text-center">
            ACRCAM Administration<span class="text-teal-600">.</span>
          </h1>
          <div id="profile" class="space-y-3">
            <a viewBox="0 0 316 316" class="navbar-brand" href=""><img class="w-10 md:w-16 rounded-full mx-auto fill-current text-gray-300" src="images_static_custom/ll.jpg" alt="Rounded avatar"/>
            <div>
              <h2
          ...
          >
            ...
            <span class="">Gestion des Activités</span>
          </a>
            <a
            ...
            >
              ...
              <span class="">Gestion des Contacts</span>
            </a>

            <a
            href="{{ route('faireundon.admin') }}"
            class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
          >
            <svg
              class="w-6 h-6 fill-current inline-block"
            ...
            <span class="">Gestion des Donateurs</span>
          </a>

            <a
              href="{{ route('imagesprojets.index') }}"
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              <svg
                class="w-6 h-6 fill-current inline-block"
            ...
            <a
              href="{{ route('imagesactivites.index') }}"
              class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
            >
              <svg
                class="w-6 h-6 fill-current inline-block"
              ...
              <span class="">Images des Activités</span>
            </a>
            ...
            >
              ...
              <span class="">Gestion des Partenaires</span>
            </a>
            ...
            >
              ...
              <span class="">Gestion des Membres ACRCAM</span>
            </a>
            <div
            href=""
            class="text-sm font-medium text-gray-700 py-2 px-2 hover:bg-teal-500 hover:text-white hover:scale-105 rounded-md transition duration-150 ease-in-out"
